...
<section id="hero" class="hero d-flex flex-column justify-content-center align-items-center" data-aos="fade" data-aos-delay="1500">
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item" style="font-weight:bolder;"><a href="{{route('showQuiz')}}">Test Your Knowledge</a></li>
            <li class="breadcrumb-item active" style="color:white;" aria-current="page">Quiz History</li>
        </ol>
      </nav>
...
<div class="table-container">
    <table>
        ...
        <tr>
            ...
            <td>{{$quiz->name}}</td>
            <td>{{$quiz->marks}}</td>
            <td>{{$quiz->quiz_updated_at}}</td>
            <td><a class="view-btn" href="{{ route('preview_quiz', ['id' => $quiz->id]) }}">View</a></td>
        </tr>
        @endforeach
    </table>
</div>
