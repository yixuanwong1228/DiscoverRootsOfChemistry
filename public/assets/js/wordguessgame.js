const options = {
    ...
    Molecule: "A group of atoms bonded together.", //Asnwer: "Hint"
    Isotopes: "Element that differ in neutron number but have the same proton number.",
    MarieCurie: "The first woman to win a Nobel Prize and the only one to win it in two different sciences.",
    AlkaliMetal: "A group of elements found in Group 1 of the periodic table, highly reactive with water.",
};
